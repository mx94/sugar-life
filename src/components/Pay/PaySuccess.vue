    ...
    <div style="height: 100%">
        ...
        <div class="con">
            <div class="main">
                ...
                <div class="btn-con">
                    <div class="btn-item">
                        <mt-button type="primary" class="look" @click="$router.push('/indent/1')">查看订单</mt-button>
                    </div>
                    <div class="btn-item">
                        <mt-button type="primary" class="continue" :plain="true"  @click="$router.push('/')">继续下单</mt-button>
                    </div>
                </div>
            </div>
        </div>
        ...
        .main
            ...
            .ok
                ...
                .img
                    width 50px
                    height 50px
                    background-image url("./icon_smilingFace @3x.png")
